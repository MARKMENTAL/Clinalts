...
void mainmenu(){
    char programbuffer[25];
    char *b = programbuffer;
    size_t bufsize = 25;
    ...
    printf("Help: '-h'\n");
    //writes user input to the 'programbuffer' buffer
    getline(&b,&bufsize,stdin);
    int stringcheck = strncmp(programbuffer, "-h", 2);
    ...
    stringcheck = strncmp(programbuffer, "photoshop", 9);
    if (stringcheck == 0){
    ...
    stringcheck = strncmp(programbuffer, "office", 6);
    if (stringcheck == 0){
    ...
    stringcheck = strncmp(programbuffer, "illustrator", 11);
    if (stringcheck == 0){
    ...
    stringcheck = strncmp(programbuffer, "notepad", 7);
    if (stringcheck == 0){
    ...
    stringcheck = strncmp(programbuffer, "winrar", 6);
    if (stringcheck == 0){
    ...
    stringcheck = strncmp(programbuffer, "solitaire", 9);
    if (stringcheck == 0){
    ...
    stringcheck = strncmp(programbuffer, "doom", 4);
    if (stringcheck == 0){
